...
namespace WindowsFormsApp1
{
    public partial class Form10 : Form
    {
        ...
        private void avialableItems( )
        {
            ...
            conn.Open();
            SqlCommand comm;
            string query = "SELECT itm.item_ID, crt.Item_Name, crt.perPrice, ist.Quantity, itm.Sale_Price FROM Items as itm, In_Store as ist, [Carton (Warehouse)] as crt WHERE itm.Item_ID = ist.Item_ID AND itm.Item_ID = crt.Item_ID;";
            string q = "Select Items.Item_ID, [Carton (Warehouse)].Item_Name, [Carton (Warehouse)].perprice, Items.Sale_Price from Items, [Carton (Warehouse)] where Items.Item_ID = [Carton (Warehouse)].Item_ID;";
